...
#24, 14, 42, 15, 28,
Input: height = [3,2,7,2,5,4,8,3,7]
Output: 49
Explanation: The above vertical lines are represented by array [1,8,6,2,5,4,8,3,7]. In this case, the max area of water (blue section) the container can contain is 49.
#15,12,15,16
Input: height = [3,8,2,10,5,3]
Output: 49
Explanation: The above vertical lines are represented by array [1,8,6,2,5,4,8,3,7]. In this case, the max area of water (blue section) the container can contain is 49.
...
console.log(waterContainerProblem([1, 8, 6, 2, 5, 4, 8, 3, 7]))
console.log(waterContainerProblem([1, 1]))
console.log(waterContainerProblem([4, 3, 2, 1, 4]))
console.log(waterContainerProblem([[1, 2, 1]]))